...
public class physicalInsecticidalsService {
	public List<Map<String,Object>> physicalInsecticidalsList() {
		List<Map<String,Object>> lists= new ArrayList<Map<String,Object>>();
		
		String sql = "SELECT DateTime,Instruction FROM ft_physicalInsecticidals ORDER BY DateTime";
		//获取DB对象
