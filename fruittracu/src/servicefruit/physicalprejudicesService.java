...
public class physicalprejudicesService {
	public List<Map<String,Object>> physicalprejudicesList() {
		List<Map<String,Object>> lists= new ArrayList<Map<String,Object>>();
		
		String sql = "SELECT DateTime,Remark FROM ft_physicalprejudices ORDER BY DateTime";
		//获取DB对象
